...
# Clear the axis for each iteration
    ...
    opvx = opdata[0]
    opvy = opdata[1]
    opvx = opvx - opax * inter                       #uses the acceleration of the x times the interval to get a new acceration
    opvy = opvy + opay * inter                       #NEEDS TO BE MINUES BC ITS WEIRD
